...
class TestRequestContext:
    ...
    def test_create_context(self):
        ...
        ctx = RequestContext(request_id="req123", trace_id="trace456", span_id="span789")
    ...
    def test_child_context(self):
        ...
        parent = RequestContext(request_id="req123", trace_id="trace456", span_id="span789")
    ...
    def test_to_dict(self):
        ...
        ctx = RequestContext(
            request_id="req123", trace_id="trace456", span_id="span789", metadata={"key": "value"}
        )
        data = ctx.to_dict()
...
class TestContextScope:
    ...
    def test_context_scope_with_provided_context(self):
        ...
        provided = RequestContext(request_id="req123", trace_id="trace456", span_id="span789")

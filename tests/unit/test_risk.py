...
class TestRiskLimits:
    ...
    def test_custom_limits(self):
        ...
        limits = RiskLimits(max_position_size=0.20, max_drawdown_pct=0.15, daily_loss_limit=2000.0)
...
class TestRiskManager:
    ...
    def test_position_size_with_stop_loss(self, risk_limits):
        ...
        quantity = manager.calculate_position_size(price=150, confidence=1.0, stop_loss_pct=0.02)
